...
const vcard1 = 'BEGIN:VCARD\n' 
            ...
            + 'ORG: Creator Can;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6283102650464:+62 851-5676-0338\n'  //kalo eror jan nanges
            + 'END:VCARD'
...
switch(command) {
            ...
            case 'randomhentong':
					client.sendMessage(from,'donasi yuk biar kami menambahkan fitur ', text, {quoted: ftroli, contextInfo: { forwardingScore: 508, isForwarded: true}})
                    break
...
teks = args.join(' ')
reply('Terima Kasih Telah Melaporkan Bug Pada Owner, Have A Nice Day!')
...
break
case 'bcgc':
					if (!isOwner) return reply(`Khusu owner om`)
...
let thumbInfo = `「  _*Youtube Search*_  」
